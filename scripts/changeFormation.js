...
[
    ...
    { Cmd: "army.changeFormation", Params: { RoleArmyID: this.#ServiceManager.roleArmy.GetRoleArmyID.bind(this.#ServiceManager.roleArmy, 1), FormationID: "1" }, Describe: '更新阵型', Immediate: true },
]